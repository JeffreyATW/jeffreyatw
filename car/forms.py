...
from jeffreyatw.car.models import Comment
...
class ReCaptchaField(forms.FileField):
    ...
    default_error_messages = {
        ...
        'verify-params-incorrect': u"The parameters to verify were \
        incorrect, make sure you are passing all the required parameters.",
    ...
    def clean(self, data, initial):
        if initial is None or initial == '':
            raise Exception("ReCaptchaField requires the client's IP be set \
